...
public:
    ...
    void AddBuilding(const shared_ptr<BuildingLayer>& buildingLayerPtr) {}

    void EnableAntennaIfNecessary(
        const ParameterDatabaseReader& theParameterDatabaseReader,
        const NodeIdType& nodeId) {}

    void EnableMovingObjectWithAntennaIfNecessary(
        const ParameterDatabaseReader& theParameterDatabaseReader,
        const NodeIdType& nodeId,
    ...
    void DisableAntennaAndMovingObject(const NodeIdType& nodeId) {}
